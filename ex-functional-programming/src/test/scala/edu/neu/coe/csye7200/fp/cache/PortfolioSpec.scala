...
class PortfolioSpec extends AnyFlatSpec with Matchers with CancelOnNotImplemented with Futures with ScalaFutures {
  ...
  it should "get value" in {
    ...
    futureOrCancelWith(xf) { u => u should matchPattern { case _: Double => } }
