 ...
 * @author scalaprof
 */
class MiniDatabaseSpec2 extends AnyFlatSpec with Inside with Matchers with CancelOnNotImplemented {
  ...
  "Entry" should """succeed: Thomas E. P. "Tom" Brady, etc.""" in {
    val ey = Entry.parse("""Thomas E. P. "Tom" Brady, 078-05-1120, Aug 3rd 1977, 6 ft 4 in, 225""".split(","))
    tryOrCancel(ey)
//    ey match {
